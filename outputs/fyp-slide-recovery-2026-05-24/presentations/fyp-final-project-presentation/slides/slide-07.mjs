...
export async function slide07(presentation, ctx) {
  ...
  title(slide, ctx, "Methodology", "Denoising-assisted AMC signal chain");
  const y = 222;
  processNode(slide, ctx, 1, "I/Q source", "Synthetic GSM-family or public I/Q windows (DeepSig, 2018).", 58, y, 178, 132, C.navy);
  ...
  bulletBox(slide, ctx, "Evaluation comparison", [
    ...
    "Both paths are evaluated under the same SNR levels and classes (O'Shea et al., 2018).",
