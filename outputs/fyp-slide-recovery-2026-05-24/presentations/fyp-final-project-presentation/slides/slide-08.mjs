...
export async function slide08(presentation, ctx) {
  ...
  title(slide, ctx, "Results: Controlled Simulation Setup", "Results basis");
  ...
  bulletBox(slide, ctx, "What was simulated", [
    "Baseband I/Q windows with GSM-family/proxy modulation structure (DeepSig, 2018).",
    "Low-SNR AWGN, narrowband interference, mild fading, and phase/frequency offset.",
    "A denoising-assisted path compared against a noisy baseline path (An & Lee, 2023)."
