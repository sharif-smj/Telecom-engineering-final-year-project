...
export async function slide11(presentation, ctx) {
  ...
  title(slide, ctx, "Discussion: what the preliminary results mean", "Interpretation");
  ...
  bulletBox(slide, ctx, "Observed pattern", [
    "The denoising-assisted path improves the controlled run overall.",
    "The clearest gain appears around the difficult 0 dB condition.",
    "Cleaner SNR conditions do not require aggressive denoising, so adaptive bypass is sensible."
